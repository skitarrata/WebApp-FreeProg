...
copy:
	...
	$(CPY) $(DIREQ)fileload.php $(DIRPHP)/fileload.php
	$(CPY) $(DIREQ)videoload.php $(DIRPHP)/videoload.php
	$(CPY) $(DIREQ)postData.php $(DIRPHP)/postData.php
	$(CPY) $(DIREQ)getData.php $(DIRPHP)/getData.php
